(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('node_modules/bootstrap/js/src/alert'), require('node_modules/bootstrap/js/src/button'), require('node_modules/bootstrap/js/src/carousel'), require('node_modules/bootstrap/js/src/collapse'), require('node_modules/bootstrap/js/src/modal'), require('node_modules/bootstrap/js/src/popover'), require('node_modules/bootstrap/js/src/scrollspy'), require('node_modules/bootstrap/js/src/tab'), require('node_modules/bootstrap/js/src/tooltip'), require('node_modules/bootstrap/js/src/util'), require('jquery')) :
	typeof define === 'function' && define.amd ? define(['node_modules/bootstrap/js/src/alert', 'node_modules/bootstrap/js/src/button', 'node_modules/bootstrap/js/src/carousel', 'node_modules/bootstrap/js/src/collapse', 'node_modules/bootstrap/js/src/modal', 'node_modules/bootstrap/js/src/popover', 'node_modules/bootstrap/js/src/scrollspy', 'node_modules/bootstrap/js/src/tab', 'node_modules/bootstrap/js/src/tooltip', 'node_modules/bootstrap/js/src/util', 'jquery'], factory) :
	(factory(null,null,null,null,null,null,null,null,null,null,global.jQuery));
  ...
  function () {
    ...
    _proto.findMdbFormGroup = function findMdbFormGroup(raiseError) {
      ...
      if (mfg.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.BMD_FORM_GROUP + " for " + Util.describe(this.$element));
      }
  ...
  function (_Base) {
    ...
    _proto.findMdbLabel = function findMdbLabel(raiseError) {
      ...
      if (label.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.BMD_LABEL_WILDCARD + " within form-group for " + Util.describe(this.$element));
      }
    ...
    _proto.findFormGroup = function findFormGroup(raiseError) {
      ...
      if (fg.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.FORM_GROUP + " for " + Util.describe(this.$element));
      }
...
var CollapseInline = function ($$$1) {
  ...
  function (_Base) {
    ...
    function CollapseInline($element, config) {
      ...
      Util.assert(_this.$collapse, !_this.$collapse.hasClass(ClassName.COLLAPSE), Util.describe(_this.$collapse) + " is expected to have the '" + ClassName.COLLAPSE + "' class.  It is being targeted by " + Util.describe($element)); // find the first input for focusing
...
function transitionEndEmulator(duration) {
  let called = false;
  $(this).one(Util$2.TRANSITION_END, () => {
    called = true;
  });
  setTimeout(() => {
    if (!called) {
      Util$2.triggerTransitionEnd(this);
    }
  }, duration);
  return this;
}
...
function setTransitionEndSupport() {
  ...
  $.event.special[Util$2.TRANSITION_END] = getSpecialTransitionEndEvent();
}
/**
 * --------------------------------------------------------------------------
 * Public Util Api
...
const Util$2 = {
  ...
  typeCheckConfig(componentName, config, configTypes) {
    for (const property in configTypes) {
      if (Object.prototype.hasOwnProperty.call(configTypes, property)) {
        ...
        const valueType = value && Util$2.isElement(value) ? 'element' : toType(value);
  ...
  findShadowRoot(element) {
    ...
    return Util$2.findShadowRoot(element.parentNode);
  }
...
var Dropdown = function ($$$1) {
  ...
  function () {
    ...
    Dropdown._getParentFromElement = function _getParentFromElement(element) {
      var parent;
      var selector = Util$2.getSelectorFromElement(element);
  ...
  function (_Base) {
    ...
    _proto.findCanvas = function findCanvas(raiseError, context) {
      ...
      if (canvas.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.CANVAS + " for " + Util.describe(context));
      }
    ...
    _proto.findBackdrop = function findBackdrop(raiseError, context) {
      ...
      if (backdrop.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.BACKDROP + " for " + Util.describe(context));
      }
    ...
    _proto.findContainer = function findContainer(raiseError, context) {
      ...
      if (container.length === 0 && raiseError) {
        $$$1.error("Failed to find " + Selector.CONTAINER + " for " + Util.describe(context));
      }
